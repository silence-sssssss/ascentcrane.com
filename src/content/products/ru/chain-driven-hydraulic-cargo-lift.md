...
description: "Chain-Driven Hydraulic Cargo Lift от Ascent Crane разработан для надежной подъемной работы, экспортных поставок и долгосрочной промышленной эксплуатации."
model: "1T"
tonnage: "300kg"
span: "1*1.28"
...
metaDescription: "Chain-Driven Hydraulic Cargo Lift от Ascent Crane сочетает надежную работу, экспортную готовность и стабильную сервисную поддержку для промышленных заказчиков и проектных поставок."
